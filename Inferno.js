...
/**
* Add medium bridge and greenhouse new look.
* Thanks alliumnsk and preacher.
*/
...
Object.keys(flamethrower).forEach(function(key2) {
    if(key2.match(/mac10/g)) {
        ...
        flamethrower[key2].particle.projType = 'fire_shot';
        ...
        flamethrower[key2].worldImg.handsBelow = false;
...
Object.keys(building).forEach(function(key3) {
    ...
    } else if(key3.match(/greenhouse_01/g)) {
        building[key3].ceiling.imgs[0].sprite = "https://surviv.io/img/map/map-building-greenhouse-ceiling-02.svg";
        building[key3].ceiling.imgs[0].pos.x = 0;
        building[key3].ceiling.imgs[0].pos.y = 0;
        building[key3].ceiling.imgs[1].sprite = "";
        building[key3].floor.imgs[0].sprite = "https://surviv.io/img/map/map-building-greenhouse-floor-02.svg";
        building[key3].floor.imgs[1].sprite = "https://surviv.io/img/map/map-building-greenhouse-floor-02.svg";
    }
})
})();
